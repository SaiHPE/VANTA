export const dict = {
  ...
  "command.provider.connect": "Connect Ollama",
  "command.server.switch": "Open server status",
  ...
  "prompt.placeholder.summarizeComments": "Summarize commentsâ€¦",
  "prompt.placeholder.summarizeComment": "Summarize commentâ€¦",
  ...
  "sidebar.gettingStarted.title": "Connect Ollama",
  "sidebar.gettingStarted.line1": "Add your local Ollama endpoint to enable model access in this workspace.",
  "sidebar.gettingStarted.line2": "Once connected, the execute agent can use those models for VM tasks.",
