...
export const dict = {
  ...
  "command.file.open": "Datei Ã¶ffnen",
  "command.tab.close": "Tab schlieÃŸen",
  "command.context.addSelection": "Auswahl zum Kontext hinzufÃ¼gen",
  "command.context.addSelection.description": "AusgewÃ¤hlte Zeilen aus der aktuellen Datei hinzufÃ¼gen",
  ...
  "command.review.toggle": "ÃœberprÃ¼fung umschalten",
  ...
  "command.steps.toggle.description": "Schritte fÃ¼r die aktuelle Nachricht anzeigen oder ausblenden",
  "command.message.previous": "Vorherige Nachricht",
  "command.message.previous.description": "Zur vorherigen Benutzernachricht gehen",
  "command.message.next": "NÃ¤chste Nachricht",
  "command.message.next.description": "Zur nÃ¤chsten Benutzernachricht gehen",
  "command.model.choose": "Modell wÃ¤hlen",
  "command.model.choose.description": "Ein anderes Modell auswÃ¤hlen",
  "command.mcp.toggle": "MCPs umschalten",
  "command.mcp.toggle.description": "MCPs umschalten",
  "command.agent.cycle": "Agent wechseln",
  "command.agent.cycle.description": "Zum nÃ¤chsten Agenten wechseln",
  "command.agent.cycle.reverse": "Agent rÃ¼ckwÃ¤rts wechseln",
  "command.agent.cycle.reverse.description": "Zum vorherigen Agenten wechseln",
  "command.model.variant.cycle": "Denkaufwand wechseln",
  "command.model.variant.cycle.description": "Zum nÃ¤chsten Aufwandslevel wechseln",
  ...
  "command.session.undo": "RÃ¼ckgÃ¤ngig",
  "command.session.undo.description": "Letzte Nachricht rÃ¼ckgÃ¤ngig machen",
  "command.session.redo": "Wiederherstellen",
  "command.session.redo.description": "Letzte rÃ¼ckgÃ¤ngig gemachte Nachricht wiederherstellen",
  "command.session.compact": "Sitzung komprimieren",
  "command.session.compact.description": "Sitzung zusammenfassen, um die KontextgrÃ¶ÃŸe zu reduzieren",
  ...
  "dialog.provider.opencode.tagline": "ZuverlÃ¤ssige, optimierte Modelle",
  "dialog.provider.opencodeGo.tagline": "KostengÃ¼nstiges Abo fÃ¼r alle",
  "dialog.provider.anthropic.note": "Mit Claude Pro/Max oder API-SchlÃ¼ssel verbinden",
  "dialog.provider.copilot.note": "Mit Copilot oder API-SchlÃ¼ssel verbinden",
  "dialog.provider.openai.note": "Mit ChatGPT Pro/Plus oder API-SchlÃ¼ssel verbinden",
  "dialog.provider.google.note": "Gemini-Modelle fÃ¼r schnelle, strukturierte Antworten",
  "dialog.provider.openrouter.note": "Zugriff auf alle unterstÃ¼tzten Modelle Ã¼ber einen Anbieter",
  "dialog.provider.vercel.note": "Einheitlicher Zugriff auf KI-Modelle mit intelligentem Routing",
  "dialog.model.select.title": "Modell auswÃ¤hlen",
  ...
  "dialog.model.unpaid.addMore.title": "Weitere Modelle von beliebten Anbietern hinzufÃ¼gen",
  ...
  "provider.connect.selectMethod": "Anmeldemethode fÃ¼r {{provider}} auswÃ¤hlen.",
  "provider.connect.method.apiKey": "API-SchlÃ¼ssel",
  "provider.connect.status.inProgress": "Autorisierung lÃ¤uft...",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-SchlÃ¼ssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in OpenCode zu nutzen.",
  "provider.connect.apiKey.label": "{{provider}} API-SchlÃ¼ssel",
  "provider.connect.apiKey.placeholder": "API-SchlÃ¼ssel",
  "provider.connect.apiKey.required": "API-SchlÃ¼ssel ist erforderlich",
  "provider.connect.opencodeZen.line1":
    "OpenCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlÃ¤ssiger, optimierter Modelle fÃ¼r Coding-Agenten.",
  ...
  "provider.connect.opencodeZen.visit.suffix": ", um Ihren API-SchlÃ¼ssel zu erhalten.",
  ...
  "provider.connect.oauth.code.invalid": "UngÃ¼ltiger Autorisierungscode",
  ...
  "provider.connect.oauth.auto.confirmationCode": "BestÃ¤tigungscode",
  "provider.connect.toast.connected.title": "{{provider}} verbunden",
  "provider.connect.toast.connected.description": "{{provider}} Modelle sind jetzt verfÃ¼gbar.",
  ...
  "provider.custom.field.apiKey.label": "API-SchlÃ¼ssel",
  "provider.custom.field.apiKey.placeholder": "API-SchlÃ¼ssel",
  "provider.custom.field.apiKey.description":
    "Optional. Leer lassen, wenn Sie die Authentifizierung Ã¼ber Header verwalten.",
  ...
  "provider.custom.models.add": "Modell hinzufÃ¼gen",
  ...
  "provider.custom.headers.add": "Header hinzufÃ¼gen",
  ...
  "provider.disconnect.toast.disconnected.description": "Die {{provider}}-Modelle sind nicht mehr verfÃ¼gbar.",
  ...
  "common.goBack": "ZurÃ¼ck",
  "common.goForward": "VorwÃ¤rts navigieren",
  ...
  "prompt.placeholder.summarizeComments": "Kommentare zusammenfassenâ€¦",
  "prompt.placeholder.summarizeComment": "Kommentar zusammenfassenâ€¦",
  ...
  "prompt.example.4": "ErklÃ¤re, wie die Authentifizierung funktioniert",
  "prompt.example.5": "SicherheitslÃ¼cken finden und beheben",
  "prompt.example.6": "Unit-Tests fÃ¼r den Benutzerdienst hinzufÃ¼gen",
  ...
  "prompt.example.12": "Eingabevalidierung hinzufÃ¼gen",
  "prompt.example.13": "Neue Komponente erstellen fÃ¼r...",
  "prompt.example.14": "Wie deploye ich dieses Projekt?",
  "prompt.example.15": "Meinen Code auf Best Practices Ã¼berprÃ¼fen",
  "prompt.example.16": "Fehlerbehandlung zu dieser Funktion hinzufÃ¼gen",
  "prompt.example.17": "ErklÃ¤re dieses Regex-Muster",
  "prompt.example.18": "Dies in TypeScript konvertieren",
  "prompt.example.19": "Logging in der gesamten Codebasis hinzufÃ¼gen",
  "prompt.example.20": "Welche AbhÃ¤ngigkeiten sind veraltet?",
  "prompt.example.21": "Hilf mir, ein Migrationsskript zu schreiben",
  "prompt.example.22": "Caching fÃ¼r diesen Endpunkt implementieren",
  "prompt.example.23": "Paginierung zu dieser Liste hinzufÃ¼gen",
  "prompt.example.24": "CLI-Befehl erstellen fÃ¼r...",
  ...
  "prompt.dropzone.file.label": "Ablegen zum @ErwÃ¤hnen der Datei",
  ...
  "prompt.action.attachFile": "Datei anhÃ¤ngen",
  "prompt.attachment.remove": "Anhang entfernen",
  "prompt.action.send": "Senden",
  "prompt.action.stop": "Stopp",
  "prompt.toast.pasteUnsupported.title": "Nicht unterstÃ¼tztes EinfÃ¼gen",
  "prompt.toast.pasteUnsupported.description": "Hier kÃ¶nnen nur Bilder oder PDFs eingefÃ¼gt werden.",
  "prompt.toast.modelAgentRequired.title": "WÃ¤hlen Sie einen Agenten und ein Modell",
  "prompt.toast.modelAgentRequired.description":
    "WÃ¤hlen Sie einen Agenten und ein Modell, bevor Sie eine Eingabe senden.",
  ...
  "mcp.status.needs_auth": "benÃ¶tigt Authentifizierung",
  ...
  "dialog.server.add.title": "Server hinzufÃ¼gen",
  "dialog.server.add.url": "Server-URL",
  "dialog.server.add.placeholder": "http://localhost:4096",
  "dialog.server.add.error": "Verbindung zum Server fehlgeschlagen",
  "dialog.server.add.checking": "PrÃ¼fen...",
  "dialog.server.add.button": "Server hinzufÃ¼gen",
  ...
  "dialog.server.default.none": "Kein Server ausgewÃ¤hlt",
  "dialog.server.default.set": "Aktuellen Server als Standard setzen",
  "dialog.server.default.clear": "LÃ¶schen",
  ...
  "dialog.server.menu.delete": "LÃ¶schen",
  ...
  "dialog.project.edit.color.select": "{{color}}-Farbe auswÃ¤hlen",
  "context.breakdown.title": "Kontext-AufschlÃ¼sselung",
  "context.breakdown.note":
    'UngefÃ¤hre AufschlÃ¼sselung der Eingabe-Token. "Andere" beinhaltet Werkzeugdefinitionen und Overhead.',
  ...
  "context.stats.lastActivity": "Letzte AktivitÃ¤t",
  ...
  "toast.model.none.title": "Kein Modell ausgewÃ¤hlt",
  ...
  "toast.context.noLineSelection.description": "WÃ¤hlen Sie zuerst einen Zeilenbereich in einem Datei-Tab aus.",
  ...
  "toast.session.listFailed.title": "Sitzungen fÃ¼r {{project}} konnten nicht geladen werden",
  "toast.update.title": "Update verfÃ¼gbar",
  "toast.update.description": "Eine neue Version von OpenCode ({{version}}) ist zur Installation verfÃ¼gbar.",
  ...
  "error.page.action.checking": "PrÃ¼fen...",
  ...
  "error.globalSync.connectFailed": "Verbindung zum Server fehlgeschlagen. LÃ¤uft ein Server unter `{{url}}`?",
  "directory.error.invalidUrl": "UngÃ¼ltiges Verzeichnis in der URL.",
  ...
  "error.chain.checkConfig": "ÃœberprÃ¼fen Sie Ihre Konfiguration (opencode.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: OpenCode unterstÃ¼tzt noch keine MCP-Authentifizierung.',
  "error.chain.providerAuthFailed": "Anbieter-Authentifizierung fehlgeschlagen ({{provider}}): {{message}}",
  "error.chain.providerInitFailed":
    'Anbieter "{{provider}}" konnte nicht initialisiert werden. ÃœberprÃ¼fen Sie Anmeldeinformationen und Konfiguration.',
  "error.chain.configJsonInvalid": "Konfigurationsdatei unter {{path}} ist kein gÃ¼ltiges JSON(C)",
  "error.chain.configJsonInvalidWithMessage":
    "Konfigurationsdatei unter {{path}} ist kein gÃ¼ltiges JSON(C): {{message}}",
  "error.chain.configDirectoryTypo":
    'Verzeichnis "{{dir}}" in {{path}} ist ungÃ¼ltig. Benennen Sie das Verzeichnis in "{{suggestion}}" um oder entfernen Sie es. Dies ist ein hÃ¤ufiger Tippfehler.',
  "error.chain.configFrontmatterError": "Frontmatter in {{path}} konnte nicht geparst werden:\n{{message}}",
  "error.chain.configInvalid": "Konfigurationsdatei unter {{path}} ist ungÃ¼ltig",
  "error.chain.configInvalidWithMessage": "Konfigurationsdatei unter {{path}} ist ungÃ¼ltig: {{message}}",
  "notification.permission.title": "Berechtigung erforderlich",
  "notification.permission.description": "{{sessionTitle}} in {{projectName}} benÃ¶tigt Berechtigung",
  ...
  "home.empty.description": "Starten Sie, indem Sie ein lokales Projekt Ã¶ffnen",
  "session.tab.session": "Sitzung",
  "session.tab.review": "ÃœberprÃ¼fung",
  "session.tab.context": "Kontext",
  "session.panel.reviewAndFiles": "ÃœberprÃ¼fung und Dateien",
  "session.review.filesChanged": "{{count}} Dateien geÃ¤ndert",
  "session.review.change.one": "Ã„nderung",
  "session.review.change.other": "Ã„nderungen",
  "session.review.loadingChanges": "Lade Ã„nderungen...",
  "session.review.empty": "Noch keine Ã„nderungen in dieser Sitzung",
  "session.review.noChanges": "Keine Ã„nderungen",
  "session.files.selectToOpen": "Datei zum Ã–ffnen auswÃ¤hlen",
  "session.files.all": "Alle Dateien",
  "session.files.binaryContent": "BinÃ¤rdatei (Inhalt kann nicht angezeigt werden)",
  "session.messages.renderEarlier": "FrÃ¼here Nachrichten rendern",
  "session.messages.loadingEarlier": "Lade frÃ¼here Nachrichten...",
  "session.messages.loadEarlier": "FrÃ¼here Nachrichten laden",
  "session.messages.loading": "Lade Nachrichten...",
  "session.messages.jumpToLatest": "Zum neuesten springen",
  "session.context.addToContext": "{{selection}} zum Kontext hinzufÃ¼gen",
  "session.todo.title": "Aufgaben",
  "session.todo.collapse": "Einklappen",
  "session.todo.expand": "Ausklappen",
  "session.new.lastModified": "Zuletzt geÃ¤ndert",
  "session.header.search.placeholder": "{{project}} durchsuchen",
  "session.header.searchFiles": "Dateien suchen",
  "session.header.openIn": "Ã–ffnen in",
  "session.header.open.action": "{{app}} Ã¶ffnen",
  "session.header.open.ariaLabel": "In {{app}} Ã¶ffnen",
  "session.header.open.menu": "Ã–ffnen-Optionen",
  ...
  "session.share.popover.title": "Im Web verÃ¶ffentlichen",
  "session.share.popover.description.shared":
    "Diese Sitzung ist Ã¶ffentlich im Web. Sie ist fÃ¼r jeden mit dem Link zugÃ¤nglich.",
  "session.share.popover.description.unshared":
    "Sitzung Ã¶ffentlich im Web teilen. Sie wird fÃ¼r jeden mit dem Link zugÃ¤nglich sein.",
  "session.share.action.share": "Teilen",
  "session.share.action.publish": "VerÃ¶ffentlichen",
  "session.share.action.publishing": "VerÃ¶ffentliche...",
  "session.share.action.unpublish": "VerÃ¶ffentlichung aufheben",
  "session.share.action.unpublishing": "Hebe VerÃ¶ffentlichung auf...",
  ...
  "terminal.close": "Terminal schlieÃŸen",
  ...
  "common.closeTab": "Tab schlieÃŸen",
  ...
  "common.key.esc": "ESC",
  "sidebar.menu.toggle": "MenÃ¼ umschalten",
  ...
  "sidebar.gettingStarted.line1": "OpenCode enthÃ¤lt kostenlose Modelle, damit Sie sofort loslegen kÃ¶nnen.",
  ...
  "sidebar.project.clearNotifications": "Benachrichtigungen lÃ¶schen",
  ...
  "settings.desktop.wsl.description": "OpenCode-Server innerhalb von WSL unter Windows ausfÃ¼hren.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache fÃ¼r OpenCode Ã¤ndern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie OpenCode auf Ihrem GerÃ¤t aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von OpenCode anpassen.",
  "settings.general.row.font.title": "Schriftart",
  "settings.general.row.font.description": "Die in CodeblÃ¶cken verwendete Monospace-Schriftart anpassen",
  "settings.general.row.shellToolPartsExpanded.title": "Shell-Tool-Abschnitte ausklappen",
  "settings.general.row.shellToolPartsExpanded.description":
    "Shell-Tool-Abschnitte standardmÃ¤ÃŸig in der Timeline ausgeklappt anzeigen",
  "settings.general.row.editToolPartsExpanded.title": "Edit-Tool-Abschnitte ausklappen",
  "settings.general.row.editToolPartsExpanded.description":
    "Edit-, Write- und Patch-Tool-Abschnitte standardmÃ¤ÃŸig in der Timeline ausgeklappt anzeigen",
  ...
  "settings.updates.row.check.description": "Manuell nach Updates suchen und installieren, wenn verfÃ¼gbar",
  "settings.updates.action.checkNow": "Jetzt prÃ¼fen",
  "settings.updates.action.checking": "Wird geprÃ¼ft...",
  ...
  "settings.general.notifications.agent.description":
    "Systembenachrichtigung anzeigen, wenn der Agent fertig ist oder Aufmerksamkeit benÃ¶tigt",
  ...
  "settings.general.sounds.agent.description": "Ton abspielen, wenn der Agent fertig ist oder Aufmerksamkeit benÃ¶tigt",
  ...
  "settings.shortcuts.reset.button": "Auf Standard zurÃ¼cksetzen",
  "settings.shortcuts.reset.toast.title": "Tastenkombinationen zurÃ¼ckgesetzt",
  "settings.shortcuts.reset.toast.description": "Die Tastenkombinationen wurden auf die Standardwerte zurÃ¼ckgesetzt.",
  ...
  "settings.shortcuts.pressKeys": "Tasten drÃ¼cken",
  "settings.shortcuts.search.placeholder": "TastenkÃ¼rzel suchen",
  "settings.shortcuts.search.empty": "Keine TastenkÃ¼rzel gefunden",
  ...
  "settings.providers.description": "Anbietereinstellungen kÃ¶nnen hier konfiguriert werden.",
  ...
  "settings.models.description": "Modelleinstellungen kÃ¶nnen hier konfiguriert werden.",
  "settings.agents.title": "Agenten",
  "settings.agents.description": "Agenteneinstellungen kÃ¶nnen hier konfiguriert werden.",
  "settings.commands.title": "Befehle",
  "settings.commands.description": "Befehlseinstellungen kÃ¶nnen hier konfiguriert werden.",
  "settings.mcp.title": "MCP",
  "settings.mcp.description": "MCP-Einstellungen kÃ¶nnen hier konfiguriert werden.",
  "settings.permissions.title": "Berechtigungen",
  "settings.permissions.description": "Steuern Sie, welche Tools der Server standardmÃ¤ÃŸig verwenden darf.",
  ...
  "settings.permissions.tool.read.description": "Lesen einer Datei (stimmt mit dem Dateipfad Ã¼berein)",
  "settings.permissions.tool.edit.title": "Bearbeiten",
  "settings.permissions.tool.edit.description":
    "Dateien Ã¤ndern, einschlieÃŸlich Bearbeitungen, SchreibvorgÃ¤ngen, Patches und Mehrfachbearbeitungen",
  "settings.permissions.tool.glob.title": "Glob",
  "settings.permissions.tool.glob.description": "Dateien mithilfe von Glob-Mustern abgleichen",
  "settings.permissions.tool.grep.title": "Grep",
  "settings.permissions.tool.grep.description": "Dateiinhalte mit regulÃ¤ren AusdrÃ¼cken durchsuchen",
  ...
  "settings.permissions.tool.bash.description": "Shell-Befehle ausfÃ¼hren",
  "settings.permissions.tool.task.title": "Aufgabe",
  "settings.permissions.tool.task.description": "Unteragenten starten",
  "settings.permissions.tool.skill.title": "FÃ¤higkeit",
  "settings.permissions.tool.skill.description": "Eine FÃ¤higkeit nach Namen laden",
  "settings.permissions.tool.lsp.title": "LSP",
  "settings.permissions.tool.lsp.description": "Language-Server-Abfragen ausfÃ¼hren",
  ...
  "settings.permissions.tool.external_directory.description": "Zugriff auf Dateien auÃŸerhalb des Projektverzeichnisses",
  "settings.permissions.tool.doom_loop.title": "Doom Loop",
  "settings.permissions.tool.doom_loop.description": "Wiederholte Tool-Aufrufe mit identischer Eingabe erkennen",
  "session.delete.failed.title": "Sitzung konnte nicht gelÃ¶scht werden",
  "session.delete.title": "Sitzung lÃ¶schen",
  "session.delete.confirm": 'Sitzung "{{name}}" lÃ¶schen?',
  "session.delete.button": "Sitzung lÃ¶schen",
  "workspace.new": "Neuer Arbeitsbereich",
  "workspace.type.local": "lokal",
  "workspace.type.sandbox": "Sandbox",
  "workspace.create.failed.title": "Arbeitsbereich konnte nicht erstellt werden",
  "workspace.delete.failed.title": "Arbeitsbereich konnte nicht gelÃ¶scht werden",
  "workspace.resetting.title": "Arbeitsbereich wird zurÃ¼ckgesetzt",
  "workspace.resetting.description": "Dies kann eine Minute dauern.",
  "workspace.reset.failed.title": "Arbeitsbereich konnte nicht zurÃ¼ckgesetzt werden",
  "workspace.reset.success.title": "Arbeitsbereich zurÃ¼ckgesetzt",
  ...
  "workspace.status.checking": "Suche nach nicht zusammengefÃ¼hrten Ã„nderungen...",
  "workspace.status.error": "Git-Status konnte nicht Ã¼berprÃ¼ft werden.",
  "workspace.status.clean": "Keine nicht zusammengefÃ¼hrten Ã„nderungen erkannt.",
  "workspace.status.dirty": "Nicht zusammengefÃ¼hrte Ã„nderungen in diesem Arbeitsbereich erkannt.",
  "workspace.delete.title": "Arbeitsbereich lÃ¶schen",
  "workspace.delete.confirm": 'Arbeitsbereich "{{name}}" lÃ¶schen?',
  "workspace.delete.button": "Arbeitsbereich lÃ¶schen",
  "workspace.reset.title": "Arbeitsbereich zurÃ¼cksetzen",
  "workspace.reset.confirm": 'Arbeitsbereich "{{name}}" zurÃ¼cksetzen?',
  "workspace.reset.button": "Arbeitsbereich zurÃ¼cksetzen",
  ...
  "workspace.reset.note": "Dadurch wird der Arbeitsbereich auf den Standard-Branch zurÃ¼ckgesetzt.",
  "common.open": "Ã–ffnen",
  ...
  "error.server.invalidConfiguration": "UngÃ¼ltige Konfiguration",
  ...
  "settings.providers.custom.description": "FÃ¼gen Sie einen OpenAI-kompatiblen Anbieter per Basis-URL hinzu.",
