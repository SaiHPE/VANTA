export const dict = {
  ...
  "prompt.toast.pasteUnsupported.title": "NepodrÅ¾ano lijepljenje",
  ...
  "error.globalSync.connectFailed": "Nije moguÄ‡e povezati se na server. Da li server radi na `{{url}}`?",
  ...
  "settings.permissions.tool.todoread.title": "ÄŒitanje liste zadataka",
  "settings.permissions.tool.todoread.description": "ÄŒitanje liste zadataka",
  ...
  "settings.permissions.tool.codesearch.description": "PretraÅ¾i kod na webu",
