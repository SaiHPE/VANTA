...
export const dict = {
  ...
  "command.category.workspace": "ArbeidsomrÃ¥de",
  ...
  "command.project.open": "Ã…pne prosjekt",
  "command.provider.connect": "Koble til leverandÃ¸r",
  "command.server.switch": "Bytt server",
  "command.settings.open": "Ã…pne innstillinger",
  "command.session.previous": "Forrige sesjon",
  "command.session.next": "Neste sesjon",
  "command.session.previous.unseen": "Forrige uleste Ã¸kt",
  "command.session.next.unseen": "Neste uleste Ã¸kt",
  ...
  "command.language.cycle": "Bytt sprÃ¥k",
  "command.language.set": "Bruk sprÃ¥k: {{language}}",

  "command.session.new": "Ny sesjon",
  "command.file.open": "Ã…pne fil",
  ...
  "command.message.previous.description": "GÃ¥ til forrige brukermelding",
  "command.message.next": "Neste melding",
  "command.message.next.description": "GÃ¥ til neste brukermelding",
  ...
  "command.model.variant.cycle.description": "Bytt til neste innsatsnivÃ¥",
  ...
  "command.workspace.toggle": "Veksle arbeidsomrÃ¥der",
  "command.workspace.toggle.description": "Enable or disable multiple workspaces in the sidebar",
  "command.session.undo": "Angre",
  "command.session.undo.description": "Angre siste melding",
  "command.session.redo": "GjÃ¸r om",
  "command.session.redo.description": "GjÃ¸r om siste angrede melding",
  "command.session.compact": "Komprimer sesjon",
  "command.session.compact.description": "Oppsummer sesjonen for Ã¥ redusere kontekststÃ¸rrelsen",
  "command.session.share": "Del sesjon",
  "command.session.share.description": "Del denne sesjonen og kopier URL-en til utklippstavlen",
  "command.session.unshare": "Slutt Ã¥ dele sesjon",
  "command.session.unshare.description": "Slutt Ã¥ dele denne sesjonen",

  "palette.search.placeholder": "SÃ¸k i filer, kommandoer og sesjoner",
  "palette.empty": "Ingen resultater funnet",
  "palette.group.commands": "Kommandoer",
  "palette.group.files": "Filer",

  "dialog.provider.search.placeholder": "SÃ¸k etter leverandÃ¸rer",
  "dialog.provider.empty": "Ingen leverandÃ¸rer funnet",
  ...
  "dialog.provider.opencode.tagline": "PÃ¥litelige, optimaliserte modeller",
  ...
  "dialog.provider.openrouter.note": "Tilgang til alle stÃ¸ttede modeller fra Ã©n leverandÃ¸r",
  "dialog.provider.vercel.note": "Enhetlig tilgang til AI-modeller med smart ruting",

  "dialog.model.select.title": "Velg modell",
  "dialog.model.search.placeholder": "SÃ¸k etter modeller",
  ...
  "dialog.model.unpaid.addMore.title": "Legg til flere modeller fra populÃ¦re leverandÃ¸rer",

  "dialog.provider.viewAll": "Vis flere leverandÃ¸rer",
  ...
  "provider.connect.method.apiKey": "API-nÃ¸kkel",
  "provider.connect.status.inProgress": "Autorisering pÃ¥gÃ¥r...",
  "provider.connect.status.waiting": "Venter pÃ¥ autorisering...",
  "provider.connect.status.failed": "Autorisering mislyktes: {{error}}",
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nÃ¸kkel for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i OpenCode.",
  "provider.connect.apiKey.label": "{{provider}} API-nÃ¸kkel",
  "provider.connect.apiKey.placeholder": "API-nÃ¸kkel",
  "provider.connect.apiKey.required": "API-nÃ¸kkel er pÃ¥krevd",
  "provider.connect.opencodeZen.line1":
    "OpenCode Zen gir deg tilgang til et utvalg av pÃ¥litelige optimaliserte modeller for kodeagenter.",
  "provider.connect.opencodeZen.line2":
    "Med Ã©n enkelt API-nÃ¸kkel fÃ¥r du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.opencodeZen.visit.prefix": "BesÃ¸k ",
  "provider.connect.opencodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.opencodeZen.visit.suffix": " for Ã¥ hente API-nÃ¸kkelen din.",
  "provider.connect.oauth.code.visit.prefix": "BesÃ¸k ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for Ã¥ hente autorisasjonskoden din for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i OpenCode.",
  "provider.connect.oauth.code.label": "{{method}} autorisasjonskode",
  "provider.connect.oauth.code.placeholder": "Autorisasjonskode",
  "provider.connect.oauth.code.required": "Autorisasjonskode er pÃ¥krevd",
  "provider.connect.oauth.code.invalid": "Ugyldig autorisasjonskode",
  "provider.connect.oauth.auto.visit.prefix": "BesÃ¸k ",
  "provider.connect.oauth.auto.visit.link": "denne lenken",
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for Ã¥ koble til kontoen din og bruke {{provider}}-modeller i OpenCode.",
  "provider.connect.oauth.auto.confirmationCode": "Bekreftelseskode",
  "provider.connect.toast.connected.title": "{{provider}} tilkoblet",
  "provider.connect.toast.connected.description": "{{provider}}-modeller er nÃ¥ tilgjengelige.",

  "provider.custom.title": "Egendefinert leverandÃ¸r",
  "provider.custom.description.prefix": "Konfigurer en OpenAI-kompatibel leverandÃ¸r. Se ",
  "provider.custom.description.link": "dokumentasjon for leverandÃ¸rkonfigurasjon",
  "provider.custom.description.suffix": ".",
  "provider.custom.field.providerID.label": "LeverandÃ¸r-ID",
  "provider.custom.field.providerID.placeholder": "minleverandÃ¸r",
  "provider.custom.field.providerID.description": "SmÃ¥ bokstaver, tall, bindestreker eller understreker",
  "provider.custom.field.name.label": "Visningsnavn",
  "provider.custom.field.name.placeholder": "Min AI-leverandÃ¸r",
  "provider.custom.field.baseURL.label": "Base-URL",
  "provider.custom.field.baseURL.placeholder": "https://api.myprovider.com/v1",
  "provider.custom.field.apiKey.label": "API-nÃ¸kkel",
  "provider.custom.field.apiKey.placeholder": "API-nÃ¸kkel",
  "provider.custom.field.apiKey.description": "Valgfritt. La stÃ¥ tomt hvis du administrerer autentisering via headers.",
  ...
  "provider.custom.error.providerID.required": "LeverandÃ¸r-ID er pÃ¥krevd",
  "provider.custom.error.providerID.format": "Bruk smÃ¥ bokstaver, tall, bindestreker eller understreker",
  "provider.custom.error.providerID.exists": "Den leverandÃ¸r-IDen finnes allerede",
  "provider.custom.error.name.required": "Visningsnavn er pÃ¥krevd",
  "provider.custom.error.baseURL.required": "Base-URL er pÃ¥krevd",
  "provider.custom.error.baseURL.format": "MÃ¥ starte med http:// eller https://",
  "provider.custom.error.required": "PÃ¥krevd",
  ...
  "common.search.placeholder": "SÃ¸k",
  "common.goBack": "GÃ¥ tilbake",
  ...
  "prompt.placeholder.normal": 'SpÃ¸r om hva som helst... "{{example}}"',
  "prompt.placeholder.simple": "SpÃ¸r om hva som helst...",
  "prompt.placeholder.summarizeComments": "Oppsummer kommentarerâ€¦",
  "prompt.placeholder.summarizeComment": "Oppsummer kommentarâ€¦",
  "prompt.mode.shell": "Shell",
  "prompt.mode.normal": "Prompt",
  "prompt.mode.shell.exit": "ESC for Ã¥ avslutte",

  "prompt.example.1": "Fiks en TODO i kodebasen",
  "prompt.example.2": "Hva er teknologistabelen i dette prosjektet?",
  "prompt.example.3": "Fiks Ã¸delagte tester",
  "prompt.example.4": "Forklar hvordan autentisering fungerer",
  "prompt.example.5": "Finn og fiks sikkerhetssÃ¥rbarheter",
  ...
  "prompt.example.9": "Hjelp meg med Ã¥ feilsÃ¸ke dette problemet",
  "prompt.example.10": "Generer API-dokumentasjon",
  "prompt.example.11": "Optimaliser databasespÃ¸rringer",
  ...
  "prompt.example.15": "GjennomgÃ¥ koden min for beste praksis",
  "prompt.example.16": "Legg til feilhÃ¥ndtering i denne funksjonen",
  "prompt.example.17": "Forklar dette regex-mÃ¸nsteret",
  ...
  "prompt.example.21": "Hjelp meg med Ã¥ skrive et migreringsskript",
  ...
  "prompt.dropzone.file.label": "Slipp for Ã¥ @nevne fil",
  ...
  "prompt.toast.pasteUnsupported.title": "Liming ikke stÃ¸ttet",
  ...
  "prompt.toast.modelAgentRequired.description": "Velg en agent og modell fÃ¸r du sender en forespÃ¸rsel.",
  ...
  "prompt.toast.promptSendFailed.title": "Kunne ikke sende forespÃ¸rsel",
  "prompt.toast.promptSendFailed.description": "Kunne ikke hente Ã¸kt",
  ...
  "dialog.fork.empty": "Ingen meldinger Ã¥ forgrene fra",

  "dialog.directory.search.placeholder": "SÃ¸k etter mapper",
  ...
  "dialog.server.search.placeholder": "SÃ¸k etter servere",
  "dialog.server.empty": "Ingen servere ennÃ¥",
  ...
  "dialog.server.default.description":
    "Koble til denne serveren ved oppstart i stedet for Ã¥ starte en lokal server. Krever omstart.",
  "dialog.server.default.none": "Ingen server valgt",
  "dialog.server.default.set": "Sett gjeldende server som standard",
  "dialog.server.default.clear": "TÃ¸m",
  ...
  "context.breakdown.note": 'Omtrentlig fordeling av input-tokens. "Annet" inkluderer verktÃ¸ydefinisjoner og overhead.',
  "context.breakdown.system": "System",
  "context.breakdown.user": "Bruker",
  "context.breakdown.assistant": "Assistent",
  "context.breakdown.tool": "VerktÃ¸ykall",
  "context.breakdown.other": "Annet",

  "context.systemPrompt.title": "Systemprompt",
  "context.rawMessages.title": "RÃ¥ meldinger",

  "context.stats.session": "Sesjon",
  "context.stats.messages": "Meldinger",
  "context.stats.provider": "LeverandÃ¸r",
  ...
  "context.usage.clickToView": "Klikk for Ã¥ se kontekst",
  ...
  "toast.language.title": "SprÃ¥k",
  "toast.language.description": "Byttet til {{language}}",

  "toast.theme.title": "Tema byttet",
  "toast.scheme.title": "Fargevalg",

  "toast.workspace.enabled.title": "ArbeidsomrÃ¥der aktivert",
  "toast.workspace.disabled.title": "ArbeidsomrÃ¥der deaktivert",

  "toast.permissions.autoaccept.on.title": "Aksepterer tillatelser automatisk",
  "toast.permissions.autoaccept.on.description": "ForespÃ¸rsler om tillatelse vil bli godkjent automatisk",
  "toast.permissions.autoaccept.off.title": "Stoppet automatisk akseptering av tillatelser",
  "toast.permissions.autoaccept.off.description": "ForespÃ¸rsler om tillatelse vil kreve godkjenning",

  "toast.model.none.title": "Ingen modell valgt",
  "toast.model.none.description": "Koble til en leverandÃ¸r for Ã¥ oppsummere denne sesjonen",
  ...
  "toast.context.noLineSelection.description": "Velg fÃ¸rst et linjeomrÃ¥de i en filfane.",
  ...
  "toast.update.description": "En ny versjon av OpenCode ({{version}}) er nÃ¥ tilgjengelig for installasjon.",
  "toast.update.action.installRestart": "Installer og start pÃ¥ nytt",
  "toast.update.action.notYet": "Ikke nÃ¥",
  ...
  "error.page.action.restart": "Start pÃ¥ nytt",
  ...
  "error.dev.rootNotFound":
    "Rotelement ikke funnet. Glemte du Ã¥ legge det til i index.html? Eller kanskje id-attributten er feilstavet?",

  "error.globalSync.connectFailed": "Kunne ikke koble til server. KjÃ¸rer det en server pÃ¥ `{{url}}`?",
  "directory.error.invalidUrl": "Invalid directory in URL.",

  "error.chain.unknown": "Ukjent feil",
  "error.chain.causedBy": "ForÃ¥rsaket av:",
  "error.chain.apiError": "API-feil",
  "error.chain.status": "Status: {{status}}",
  "error.chain.retryable": "Kan prÃ¸ves pÃ¥ nytt: {{retryable}}",
  "error.chain.responseBody": "Responsinnhold:\n{{body}}",
  "error.chain.didYouMean": "Mente du: {{suggestions}}",
  "error.chain.modelNotFound": "Modell ikke funnet: {{provider}}/{{model}}",
  "error.chain.checkConfig": "Sjekk leverandÃ¸r-/modellnavnene i konfigurasjonen din (opencode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at OpenCode ikke stÃ¸tter MCP-autentisering ennÃ¥.',
  "error.chain.providerAuthFailed": "LeverandÃ¸rautentisering mislyktes ({{provider}}): {{message}}",
  "error.chain.providerInitFailed":
    'Kunne ikke initialisere leverandÃ¸r "{{provider}}". Sjekk legitimasjon og konfigurasjon.',
  "error.chain.configJsonInvalid": "Konfigurasjonsfilen pÃ¥ {{path}} er ikke gyldig JSON(C)",
  "error.chain.configJsonInvalidWithMessage": "Konfigurasjonsfilen pÃ¥ {{path}} er ikke gyldig JSON(C): {{message}}",
  ...
  "error.chain.configInvalid": "Konfigurasjonsfilen pÃ¥ {{path}} er ugyldig",
  "error.chain.configInvalidWithMessage": "Konfigurasjonsfilen pÃ¥ {{path}} er ugyldig: {{message}}",

  "notification.permission.title": "Tillatelse pÃ¥krevd",
  "notification.permission.description": "{{sessionTitle}} i {{projectName}} trenger tillatelse",
  "notification.question.title": "SpÃ¸rsmÃ¥l",
  "notification.question.description": "{{sessionTitle}} i {{projectName}} har et spÃ¸rsmÃ¥l",
  "notification.action.goToSession": "GÃ¥ til sesjon",
  ...
  "home.empty.description": "Kom i gang ved Ã¥ Ã¥pne et lokalt prosjekt",
  ...
  "session.review.empty": "Ingen endringer i denne sesjonen ennÃ¥",
  "session.review.noChanges": "Ingen endringer",

  "session.files.selectToOpen": "Velg en fil Ã¥ Ã¥pne",
  "session.files.all": "Alle filer",
  "session.files.binaryContent": "BinÃ¦r fil (innhold kan ikke vises)",
  ...
  "session.header.search.placeholder": "SÃ¸k i {{project}}",
  "session.header.searchFiles": "SÃ¸k etter filer",
  "session.header.openIn": "Ã…pne i",
  "session.header.open.action": "Ã…pne {{app}}",
  "session.header.open.ariaLabel": "Ã…pne i {{app}}",
  "session.header.open.menu": "Ã…pne alternativer",
  ...
  "session.share.popover.title": "Publiser pÃ¥ nett",
  "session.share.popover.description.shared":
    "Denne sesjonen er offentlig pÃ¥ nettet. Den er tilgjengelig for alle med lenken.",
  "session.share.popover.description.unshared":
    "Del sesjonen offentlig pÃ¥ nettet. Den vil vÃ¦re tilgjengelig for alle med lenken.",
  ...
  "terminal.connectionLost.description":
    "Terminalforbindelsen ble avbrutt. Dette kan skje nÃ¥r serveren starter pÃ¥ nytt.",

  "common.closeTab": "Lukk fane",
  "common.dismiss": "Avvis",
  "common.requestFailed": "ForespÃ¸rsel mislyktes",
  "common.moreOptions": "Flere alternativer",
  "common.learnMore": "LÃ¦r mer",
  ...
  "sidebar.help": "Hjelp",
  "sidebar.workspaces.enable": "Aktiver arbeidsomrÃ¥der",
  "sidebar.workspaces.disable": "Deaktiver arbeidsomrÃ¥der",
  "sidebar.gettingStarted.title": "Kom i gang",
  "sidebar.gettingStarted.line1": "OpenCode inkluderer gratis modeller sÃ¥ du kan starte umiddelbart.",
  "sidebar.gettingStarted.line2": "Koble til en leverandÃ¸r for Ã¥ bruke modeller, inkl. Claude, GPT, Gemini osv.",
  ...
  "settings.desktop.wsl.description": "KjÃ¸r OpenCode-serveren i WSL pÃ¥ Windows.",
  ...
  "settings.general.row.language.title": "SprÃ¥k",
  "settings.general.row.language.description": "Endre visningssprÃ¥ket for OpenCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan OpenCode ser ut pÃ¥ enheten din",
  ...
  "settings.general.row.shellToolPartsExpanded.title": "Utvid shell-verktÃ¸ydeler",
  "settings.general.row.shellToolPartsExpanded.description": "Vis shell-verktÃ¸ydeler utvidet som standard i tidslinjen",
  "settings.general.row.editToolPartsExpanded.title": "Utvid edit-verktÃ¸ydeler",
  "settings.general.row.editToolPartsExpanded.description":
    "Vis edit-, write- og patch-verktÃ¸ydeler utvidet som standard i tidslinjen",
  "settings.general.row.wayland.title": "Bruk innebygd Wayland",
  "settings.general.row.wayland.description": "Deaktiver X11-fallback pÃ¥ Wayland. Krever omstart.",
  "settings.general.row.wayland.tooltip":
    "PÃ¥ Linux med skjermer med blandet oppdateringsfrekvens kan innebygd Wayland vÃ¦re mer stabilt.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer nÃ¥r OpenCode starter",
  ...
  "settings.updates.action.checkNow": "Sjekk nÃ¥",
  ...
  "settings.general.notifications.agent.description":
    "Vis systemvarsel nÃ¥r agenten er ferdig eller trenger oppmerksomhet",
  "settings.general.notifications.permissions.title": "Tillatelser",
  "settings.general.notifications.permissions.description": "Vis systemvarsel nÃ¥r en tillatelse er pÃ¥krevd",
  "settings.general.notifications.errors.title": "Feil",
  "settings.general.notifications.errors.description": "Vis systemvarsel nÃ¥r det oppstÃ¥r en feil",

  "settings.general.sounds.agent.title": "Agent",
  "settings.general.sounds.agent.description": "Spill av lyd nÃ¥r agenten er ferdig eller trenger oppmerksomhet",
  "settings.general.sounds.permissions.title": "Tillatelser",
  "settings.general.sounds.permissions.description": "Spill av lyd nÃ¥r en tillatelse er pÃ¥krevd",
  "settings.general.sounds.errors.title": "Feil",
  "settings.general.sounds.errors.description": "Spill av lyd nÃ¥r det oppstÃ¥r en feil",
  ...
  "settings.shortcuts.search.placeholder": "SÃ¸k etter snarveier",
  ...
  "settings.providers.title": "LeverandÃ¸rer",
  "settings.providers.description": "LeverandÃ¸rinnstillinger vil kunne konfigureres her.",
  "settings.providers.section.connected": "Tilkoblede leverandÃ¸rer",
  "settings.providers.connected.empty": "Ingen tilkoblede leverandÃ¸rer",
  "settings.providers.section.popular": "PopulÃ¦re leverandÃ¸rer",
  ...
  "settings.permissions.description": "Kontroller hvilke verktÃ¸y serveren kan bruke som standard.",
  "settings.permissions.section.tools": "VerktÃ¸y",
  "settings.permissions.toast.updateFailed.title": "Kunne ikke oppdatere tillatelser",

  "settings.permissions.action.allow": "Tillat",
  "settings.permissions.action.ask": "SpÃ¸r",
  "settings.permissions.action.deny": "AvslÃ¥",
  ...
  "settings.permissions.tool.glob.description": "Match filer ved hjelp av glob-mÃ¸nstre",
  "settings.permissions.tool.grep.title": "Grep",
  "settings.permissions.tool.grep.description": "SÃ¸k i filinnhold ved hjelp av regulÃ¦re uttrykk",
  "settings.permissions.tool.list.title": "Liste",
  "settings.permissions.tool.list.description": "List filer i en mappe",
  "settings.permissions.tool.bash.title": "Bash",
  "settings.permissions.tool.bash.description": "KjÃ¸r shell-kommandoer",
  ...
  "settings.permissions.tool.lsp.description": "KjÃ¸r sprÃ¥kserverforespÃ¸rsler",
  "settings.permissions.tool.todoread.title": "Les gjÃ¸remÃ¥l",
  "settings.permissions.tool.todoread.description": "Les gjÃ¸remÃ¥lslisten",
  "settings.permissions.tool.todowrite.title": "Skriv gjÃ¸remÃ¥l",
  "settings.permissions.tool.todowrite.description": "Oppdater gjÃ¸remÃ¥lslisten",
  ...
  "settings.permissions.tool.websearch.title": "WebsÃ¸k",
  "settings.permissions.tool.websearch.description": "SÃ¸k pÃ¥ nettet",
  "settings.permissions.tool.codesearch.title": "KodesÃ¸k",
  "settings.permissions.tool.codesearch.description": "SÃ¸k etter kode pÃ¥ nettet",
  "settings.permissions.tool.external_directory.title": "Ekstern mappe",
  "settings.permissions.tool.external_directory.description": "FÃ¥ tilgang til filer utenfor prosjektmappen",
  "settings.permissions.tool.doom_loop.title": "Doom Loop",
  "settings.permissions.tool.doom_loop.description": "Oppdager gjentatte verktÃ¸ykall med identisk input",
  ...
  "workspace.new": "Nytt arbeidsomrÃ¥de",
  "workspace.type.local": "lokal",
  "workspace.type.sandbox": "sandkasse",
  "workspace.create.failed.title": "Kunne ikke opprette arbeidsomrÃ¥de",
  "workspace.delete.failed.title": "Kunne ikke slette arbeidsomrÃ¥de",
  "workspace.resetting.title": "Tilbakestiller arbeidsomrÃ¥de",
  "workspace.resetting.description": "Dette kan ta et minutt.",
  "workspace.reset.failed.title": "Kunne ikke tilbakestille arbeidsomrÃ¥de",
  "workspace.reset.success.title": "ArbeidsomrÃ¥de tilbakestilt",
  "workspace.reset.success.description": "ArbeidsomrÃ¥det samsvarer nÃ¥ med standardgrenen.",
  "workspace.error.stillPreparing": "ArbeidsomrÃ¥det klargjÃ¸res fortsatt",
  "workspace.status.checking": "Sjekker for ikke-sammenslÃ¥tte endringer...",
  "workspace.status.error": "Kunne ikke bekrefte git-status.",
  "workspace.status.clean": "Ingen ikke-sammenslÃ¥tte endringer oppdaget.",
  "workspace.status.dirty": "Ikke-sammenslÃ¥tte endringer oppdaget i dette arbeidsomrÃ¥det.",
  "workspace.delete.title": "Slett arbeidsomrÃ¥de",
  "workspace.delete.confirm": 'Slette arbeidsomrÃ¥det "{{name}}"?',
  "workspace.delete.button": "Slett arbeidsomrÃ¥de",
  "workspace.reset.title": "Tilbakestill arbeidsomrÃ¥de",
  "workspace.reset.confirm": 'Tilbakestille arbeidsomrÃ¥det "{{name}}"?',
  "workspace.reset.button": "Tilbakestill arbeidsomrÃ¥de",
  ...
  "workspace.reset.note": "Dette vil tilbakestille arbeidsomrÃ¥det til Ã¥ samsvare med standardgrenen.",
  "common.open": "Ã…pne",
  ...
  "dialog.releaseNotes.media.alt": "ForhÃ¥ndsvisning av utgivelse",
  "toast.project.reloadFailed.title": "Kunne ikke laste inn {{project}} pÃ¥ nytt",
  "error.server.invalidConfiguration": "Ugyldig konfigurasjon",
  "common.moreCountSuffix": " (+{{count}} mer)",
  "common.time.justNow": "Akkurat nÃ¥",
  ...
  "settings.providers.connected.environmentDescription": "Koblet til fra miljÃ¸variablene dine",
  "settings.providers.custom.description": "Legg til en OpenAI-kompatibel leverandÃ¸r via basis-URL.",
